...
def generate_markdown_report(summary: EvaluationSummary) -> str:
    ...
    lines = [
        ...
        f"- Provider: {cohort.provider or 'not measured'}",
        f"- Model: {cohort.model or 'not measured'}",
        f"- Reasoning mode: {cohort.reasoning_mode or 'not measured'}",
        f"- Reasoning schema: {cohort.reasoning_schema_version or 'not measured'}",
